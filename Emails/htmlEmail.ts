  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <a href="http://localhost:5173/api/v1/user/verify-email?token=${verificationToken}" class="cta-button">Verify My Email</a>
      ...
      <div class="footer">
        ...
        <p>Need help? <a href="http://localhost:5173/contact">Contact Support</a></p>
      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-body">
            ...
            <!-- Call to Action Button -->
            <div class="button-container">
              <a href="http://localhost:5173/order/status?orderId=${orderId}" class="button">Give Feedback</a>
            </div>
      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-body">
            ...
            <!-- Action Button -->
            <div class="button-container">
              <a href="http://localhost:5173/order/status" class="button">View Order Status</a>
            </div>
